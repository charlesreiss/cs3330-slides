...
\begin{frame}{bitwise AND --- C/assembly}
    \begin{itemize}
    \item x86: {\tt {\keywordstyle and} \%reg, \%reg}
    \item C: \cinline|foo & bar|
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile,label=extractOp3]{extract opcode from larger}
\begin{ccodeNL}
...
\begin{frame}[fragile,label=extractOp4]{extract opcode from larger}
\begin{asmcodeNL}
