\begin{frame}[fragile,label=addqStall]{addq processor: data hazard stall}
\begin{tikzpicture}[overlay,remember picture]
    \node[anchor=north east] (pBox) at ([xshift=-.5cm,yshift=-1cm]current page.north east)
...
\begin{frame}[fragile,label=addqStallInstrs]{addq stall}
    \lstset{style=small}
\begin{lstlisting}
addq %r8, %r9 
// hardware stalls twice
...
\begin{tikzpicture}
    ...
    \matrix[tight matrix,matrix stages,
        ...
        2    \& |[conflictInstr]| addq \%r9, \%r8 \& nop ``bubble'' \& |[blue]| addq \%r8, \%r9 \\
        3    \& |[conflictInstr]| addq \%r9, \%r8 \& nop ``bubble'' \& nop ``bubble'' \& |[blue]| addq \%r8, \%r9\\
    ...
    \begin{scope}[thick,-Latex]
        ...
        \draw (timeline-3-2) -- (timeline-4-2);
        \draw (timeline-4-2) -- (timeline-5-2);
        \draw (timeline-5-2) -- (timeline-6-3);
