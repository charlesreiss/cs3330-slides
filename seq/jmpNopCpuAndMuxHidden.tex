\begin{frame}<0|handout:0>[fragile,label=Muxes]{multiplexers}
...
\begin{frame}<0|handout:0>[fragile,label=JmpNoOpIntro]{Simple ISA 3: Jmp or No-Op}
    \begin{itemize}
...
\begin{frame}<0|handout:0>[fragile,label=JmpNopCPU]{jmp+nop CPU}
